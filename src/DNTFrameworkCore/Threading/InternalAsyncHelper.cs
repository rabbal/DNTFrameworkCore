...
namespace DNTFrameworkCore.Threading
{
    internal static class InternalAsyncHelper
    {
        ...
        public static async Task<T> AwaitTaskWithFinallyAndGetResult<T>(Task<T> actualReturnValue,
            Action<Exception, Task> finalAction)
        {
            Exception exception = null;
        ...
        public static async Task AwaitTaskWithUsingActionAndFinally(Func<IDisposable> usingAction, Func<Task> action,
            Action<Exception> finalAction)
        {
            Exception exception = null;
        ...
        public static async Task<T> AwaitTaskWithUsingActionAndFinallyAndGetResult<T>(Func<IDisposable> usingAction,
            Func<object> action, Action<Exception> finalAction)
        {
            Exception exception = null;
        ...
        public static object CallAwaitTaskWithUsingActionAndFinallyAndGetResult(Type taskReturnType,
            Func<IDisposable> usingAction, Func<object> action, Action<Exception> finalAction)
        {
            return typeof(InternalAsyncHelper)
