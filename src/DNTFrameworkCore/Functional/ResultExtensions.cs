...
namespace DNTFrameworkCore.Functional
{
    public static class ResultExtensions
    {
        ...
        public static async Task<Result<T>> OnSuccess<T>(this Task<Result> resultTask, Func<Task<T>> func)
        {
            ...
            if (!result.Succeeded) Result.Failed<T>(result.Message, result.Failures);
        ...
        public static async Task<Result<TK>> OnSuccess<T, TK>(this Task<Result<T>> resultTask, Func<T, Task<Result<TK>>> func)
        {
            ...
            if (!result.Succeeded) Result.Failed<TK>(result.Message, result.Failures);
        ...
        public static async Task<Result> OnSuccess<T>(this Task<Result<T>> resultTask, Func<T, Task<Result>> func)
        {
            ...
            if (!result.Succeeded) Result.Failed(result.Message, result.Failures);
