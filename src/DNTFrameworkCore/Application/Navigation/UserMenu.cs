...
namespace DNTFrameworkCore.Application.Navigation
{
    ...
    public class UserMenu
    {
        ...
        /// </summary>
        internal UserMenu(MenuDefinition menuDefinition, IStringLocalizerFactory localizerFactory)
        {
            Name = menuDefinition.Name;
            DisplayName = menuDefinition.DisplayName.Localize(localizerFactory);
