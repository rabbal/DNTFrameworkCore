...
namespace DNTFrameworkCore.Configuration
{
    ...
    public interface ISettingService : IScopedDependency
    {
        ...
        Task<string> ReadValueForApplicationAsync(string name);
        ...
        /// <returns>Current value of the setting for the application</returns>
        Task<string> ReadValueForApplicationAsync(string name, bool fallbackToDefault);
        ...
        /// <returns>Current value of the setting</returns>
        Task<string> ReadValueForTenantAsync(string name, long tenantId);
        ...
        /// <param name="fallbackToDefault"></param>
        /// <returns>Current value of the setting</returns>
        Task<string> ReadValueForTenantAsync(string name, long tenantId, bool fallbackToDefault);
        ...
        Task<string> ReadValueForUserAsync(string name, long? tenantId, long userId);
        ...
        /// <param name="fallbackToDefault"></param>
        /// <returns>Current value of the setting for the user</returns>
        Task<string> ReadValueForUserAsync(string name, long? tenantId, long userId, bool fallbackToDefault);
        ...
        /// <returns>Current value of the setting for the user</returns>
        Task<string> ReadValueForUserAsync(string name, UserIdentifier user);
        ...
        Task<IReadOnlyList<ISettingValue>> ReadValuesAsync();
        ...
        /// <returns>List of setting values</returns>
        Task<IReadOnlyList<ISettingValue>> ReadValuesAsync(SettingScopes scopes);
        ...
        /// If you want to get current values of all settings, use <see cref="ReadValuesAsync()"/> method.
        /// </summary>
        /// <returns>List of setting values</returns>
        Task<IReadOnlyList<ISettingValue>> ReadValuesForApplicationAsync();
        ...
        /// <returns>List of setting values</returns>
        Task<IReadOnlyList<ISettingValue>> ReadValuesForTenantAsync(long tenantId);
        ...
        Task<IReadOnlyList<ISettingValue>> ReadValuesForUserAsync(UserIdentifier user);
        ...
        /// <param name="name">Unique name of the setting</param>
        /// <param name="value">Value of the setting</param>
        Task ChangeSettingForTenantAsync(long tenantId, string name, string value);
