...
namespace DNTFrameworkCore.Logging
{
    ...
    {
        public const int FIND_ITEM = 1001;
        public const int FIND_ITEMS = 1002;
        public const int READ_ITEMS = 1003;
        public const int CREATE_ITEM = 1004;
        public const int EDIT_ITEM = 1005;
        public const int DELETE_ITEM = 1006;
