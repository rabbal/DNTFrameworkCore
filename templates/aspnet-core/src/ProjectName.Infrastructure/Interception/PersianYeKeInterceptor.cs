...
namespace ProjectName.Infrastructure.Interception
{
    public class PersianYeKeInterceptor : DbCommandInterceptor
    {
            ...
            foreach (DbParameter parameter in command.Parameters)
            {
                switch (parameter.DbType)
                {
                    ...
                    case DbType.Xml:
                        ...
                        {
                            parameter.Value = Convert.ToString(parameter.Value, CultureInfo.InvariantCulture)
                                .ApplyCorrectYeKe();
                        }
