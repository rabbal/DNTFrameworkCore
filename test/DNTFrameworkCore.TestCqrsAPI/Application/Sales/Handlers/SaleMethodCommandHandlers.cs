...
{
    // public class SaleMethodCommandHandlerBase : CommandHandlerBase<NewSaleMethod>
    // {
    //     private readonly IUnitOfWork _uow;
    //     private readonly ISaleMethodRepository _repository;
    //
    //     public SaleMethodCommandHandlerBase(IUnitOfWork uow, ISaleMethodRepository repository)
    //     {
    //         _uow = uow;
